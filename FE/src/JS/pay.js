  // Mảng chứa dữ liệu địa chỉ
        let data = [
            { n: "Phàn Trục Ngọc", p: "333 690 457", d: "15/8, Đông Hưng Thuận 15, P. Đông Hưng Thuận, Q. 11, TP. Hồ Chí Minh", def: true },
            { n: "Lê Văn Thành", p: "392 461 235", d: "5, Tổ 9, Ấp Lê Thành, Xã Tân Phú, Huyện Châu Thành, Sài gòn", def: false }
        ];
        ...
        function confirmAddrSelection() {
            ...
            if (selected) {
                ...
                document.getElementById('display-name').innerText = `${sel.n} (+84) ${sel.p}`;
                document.getElementById('display-address').innerHTML = `${sel.d} ${sel.def ? '<span class="badge">Mặc định</span>' : ''}`;
                closeModal('modalList');
            }
        }
